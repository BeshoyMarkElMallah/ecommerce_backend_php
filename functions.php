...
function sendGCM($title, $message, $topic, $pageid, $pagename)
{
    ...
    $headers = array(
        'Authorization: key=' . "AAAAlCqGGY0:APA91bHLl7mDRUZGEMND1i9v2aB-BTQ2gJrxhCjRJyQXsIdOUQu4pQv6bH96TpPYRsdpYQPBaumRXQET2eRHQiS2nTMkusBSBKmicQGeJmH_NgeLYN1q1cNj8MO3X6LRsIse9Q6idsFm",
...
{
    $header = "From: besho.elmallah@gmail.com";
